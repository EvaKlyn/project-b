...
@export var JUMP : String = "a_jump"
@export var LEFT : String = "a_left"
@export var RIGHT : String = "a_right"
@export var FORWARD : String = "a_forward"
@export var BACKWARD : String = "a_backward"
@export var PAUSE : String = "ui_cancel"
@export var CROUCH : String = "a_crouch"
@export var SPRINT : String = "a_sprint"
